...
datasets(package = 'dslabs', lib.loc = NULL, all = TRUE, drop.defaults = FALSE)
datasets.load()
# use dataset gapminder from dslabs package----------
head(gapminder)
dim(gapminder)
gapminder %>% count(country)
# nest the df by country-----------------------------
...
identical(gapminder, arrange(gap_unnested,year))
